    ...
    <SectionBox>
      <form action={save}>
        ...
        <button
          ...
          <FontAwesomeIcon className="h-4 bg-blue-500 text-white p-1 rounded-full aspect-square" icon={faPlus} />
          <span>Add new</span>
        </button>
        <div className="">
          <ReactSortable
            ...
            {links.map(l => (
              <div key={l.key} className="mt-8 md:flex gap-6 items-center">
                <div className="handle">
                  <FontAwesomeIcon
                    className="h-4 text-gray-500 mr-2 cursor-ns-resize"
                    icon={faGripLines} />
                </div>
        ...
        <div className="border-t pt-4 mt-4">
          <SubmitButton className="max-w-xs mx-auto">
            <FontAwesomeIcon className="h-4" icon={faSave} />
            <span>Save</span>
          </SubmitButton>
        </div>
      </form>
